...
{
    public class PostgreSQLStateLevelImporterWorker : AbstractStateLevelImporterWorker
    {
        #region Properties

        #endregion

        public PostgreSQLStateLevelImporterWorker() : base() { }

        public PostgreSQLStateLevelImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager)
