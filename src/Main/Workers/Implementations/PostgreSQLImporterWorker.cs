...
{
    public abstract class PostgreSQLImporterWorker : AbstractImporterWorker
    {
        #region Properties
        ...
        public PostgreSQLImporterWorker()
            : base() { }

        public PostgreSQLImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager queryManager, ISchemaManager schemaManager)
