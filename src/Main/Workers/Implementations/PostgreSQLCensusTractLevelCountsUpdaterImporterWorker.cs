...
{
    public class PostgreSQLCensusTractLevelCountsUpdaterImporterWorker : AbstractCensusTractLevelCountsUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public PostgreSQLCensusTractLevelCountsUpdaterImporterWorker() : base() { }

        public PostgreSQLCensusTractLevelCountsUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
