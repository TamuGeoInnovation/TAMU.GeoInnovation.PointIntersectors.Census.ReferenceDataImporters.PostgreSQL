...
{
    public class PostgreSQLCensusTractLevelIndexUpdaterImporterWorker : AbstractCensusTractLevelIndexUpdaterImporterWorker
    {
        #region Properties

        #endregion

        public PostgreSQLCensusTractLevelIndexUpdaterImporterWorker() : base() { }

        public PostgreSQLCensusTractLevelIndexUpdaterImporterWorker(TraceSource traceSource, BackgroundWorker backgroundWorker, IQueryManager outputDataQueryManager, ISchemaManager schemaManager) : base(traceSource, backgroundWorker, outputDataQueryManager, schemaManager) { }
