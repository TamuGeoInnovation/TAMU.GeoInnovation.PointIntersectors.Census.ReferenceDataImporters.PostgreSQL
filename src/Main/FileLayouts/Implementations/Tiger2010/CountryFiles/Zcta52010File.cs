...
namespace TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.PostgreSQL.FileLayouts.Implementations.Tiger2010.CountryFiles
{
    public class Zcta52010File : AbstractTiger2010ShapefileCountryFileLayout
    {
            ...
            : base(stateName)
        {
            ...
            SQLCreateTableIndexes += " CREATE INDEX IDX_" + OutputTableName + "zcta5ce10 ON " + OutputTableName + " (zcta5ce10);";
        }
    }
}
